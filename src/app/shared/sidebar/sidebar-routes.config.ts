...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '', title: 'Dashboard', icon: 'ft-home', class: 'has-sub', badge: '1', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', isExternalLink: false, submenu: [
            { path: '/dashboard/dashboard1', title: 'Monitor', icon: 'ft-activity', class: '', badge: '1', badgeClass: '', isExternalLink: false, submenu: [] },
        ]
    },
    {
        path: '', title: 'Devices', icon: 'ft-home', class: 'has-sub', badge: '', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', isExternalLink: false, submenu: [
            { path: '/devices/create', title: 'Create', icon: 'ft-plus', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/devices/edit', title: 'Edit', icon: 'ft-edit', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/devices/delete', title: 'Delete', icon: 'ft-trash-2', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] }
        ]
    },
